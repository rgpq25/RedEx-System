...
import { Paquete, RowVuelosType, Vuelo } from "@/lib/types";
...
export function FlightTable<TData, TValue>({ columns, data }: DataTableProps<TData, TValue>) {
	...
	return (
		<div className="flex-1 flex flex-col mt-2">
			...
			<div className="rounded-md overflow-hidden border mt-3 flex-1 flex">
