...
public class Paquete {
    ...
    public Paquete(int id, boolean en_almacen, String codigo_ciudad_almacen, boolean entregado, PlanRuta plan_rutas, String id_ciudad_destino, Date fecha_maxima_entrega,
