...
public class PSO {
    ...
    static double fitness(List<Integer> position, ArrayList<Paquete> packages,
            HashMap<Integer, ArrayList<PlanRuta>> rutas, ArrayList<Aeropuerto> aeropuertos,
        ...
        EstadoAlmacen estado = new EstadoAlmacen(packages, planRutasEscogidas, vuelos_map, ocupacionVuelos,
                aeropuertos);
        ...
        for (Map.Entry<Integer, Integer> entry : ocupacionVuelos.entrySet()) {
            if (entry.getValue() > vuelos_map.get(entry.getKey()).getPlan_vuelo().getCapacidad_maxima()) {
                ...
                costoVuelos += (double) entry.getValue()
                        / vuelos_map.get(entry.getKey()).getPlan_vuelo().getCapacidad_maxima();
            }
        }
    ...
    static int[] pso(ArrayList<Paquete> packages, HashMap<Integer, ArrayList<PlanRuta>> rutas,
            ArrayList<Aeropuerto> aeropuertos, HashMap<Integer, Vuelo> vuelos_map,
