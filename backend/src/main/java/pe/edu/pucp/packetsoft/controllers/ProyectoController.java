...
public class ProyectoController {
    ...
    @GetMapping(value = "/listarProyectosPorNombreYJefeDeProyecto/{nombre}/{idJefe}")
    List<Proyecto> get(@PathVariable String nombre,@PathVariable int idJefe){
        return proyectoService.listarProyectosPorNombreYJefeDeProyecto(nombre,idJefe);
    }
    ...
    @CrossOrigin(origins = "https://proyectaserver.inf.pucp.edu.pe")
    @GetMapping(value = "/listarProyectosPorJefeDeProyecto/{idJefeDeProyecto}")
    List<Proyecto> listarProyectosPorJefeDeProyecto(@PathVariable int idJefeDeProyecto){
        return proyectoService.listarProyectosPorJefeDeProyecto(idJefeDeProyecto);
    }

    @CrossOrigin(origins = "https://proyectaserver.inf.pucp.edu.pe")
    @GetMapping(value = "/listarProyectosPorJefeDeProyectoOrder/{idJefeDeProyecto}")
    List<Proyecto> listarProyectosPorJefeDeProyectoOrdenado(@PathVariable int idJefeDeProyecto){
        return proyectoService.listarProyectosPorJefeDeProyectoOrdenado(idJefeDeProyecto);
    }

    @CrossOrigin(origins = "https://proyectaserver.inf.pucp.edu.pe")
    @GetMapping(value = "/listarProyectosPorGrupoDeProyectos/{idGrupoDeProyectos}")
    List<Proyecto> listarProyectosPorGrupoDeProyectos(@PathVariable int idGrupoDeProyectos){
        return proyectoService.listarProyectosPorGrupoDeProyectos(idGrupoDeProyectos);
    }
}
