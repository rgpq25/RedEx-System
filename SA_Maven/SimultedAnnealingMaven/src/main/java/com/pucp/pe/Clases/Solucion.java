...
public class Solucion {
    ...
    public double getSolutionCost() {
        ...
        cost += this.getFlightCost(); // TODO: This should return sumatoria de porcentajes utilizados en todos los
                                      // vuelos usados
    ...
    public Solucion generateNeighbour(HashMap<String, ArrayList<PlanRuta>> todasLasRutas, int windowSize) {
        ...
        for (int j = 0; j < windowSize; j++) {
            ...
            while (true) {
                ...
                // TODO: Pendiente forzar airport capacity (done) y flight capacity, mas no
                // isCurrentRouteValid
                if (neighbour.isCurrentRouteValid(randomPackages.get(j), randomRoute) == true
                    ...
                    // if (neighbour.isCurrentRouteValid(randomPackageIndexes[j]) == false) { // su
                    // solucion no era
                    // // valida
    ...
    public double getFlightCost() {
        ...
        // TODO: This cost should consider the cost stablished by Jose in the Paint
        // presentation
        double flightCost = 0;
        for (HashMap.Entry<Integer, Integer> entry : ocupacionVuelos.entrySet()) {
            Vuelo vuelo = vuelos_hash.get(entry.getKey());
    ...
    public Solucion generateNeighbourSteroids(HashMap<String, ArrayList<PlanRuta>> todasLasRutas, int windowSize) {
        ...
        for (int j = 0; j < windowSize; j++) {
            ...
            while (true) {
                ...
                if (neighbour.isCurrentRouteOnValidStartDate(randomPackages.get(j), randomRoute) == true
                        &&
                        neighbour.isRouteFlightsCapacityAvailable(randomRoute) == true) {
                    // if (
